...
# Extract columns from review data
...
# Filter out only 2019, 2020 and 2021 reviews

```{r eval=F}
reviews <- foreach(i = seq(1, 20), .combine = "rbind") %do% {
...
save(reviews, file = "../review_data/reviews19_20_21.RData")
```
