...
combined_reviews |>
  ...
  labs(title = "Average polarity over time for Asian, Mexican and pizza restaurants", color = "Cuisine", x = "Date", y = "Mean rating") +
  theme_minimal()
```
...
ggplot(data = one_star_df, aes(x = date_lub, y = polarity, color = type)) +
  ...
  labs(title = "Polarity over time for 1 star reviews", color = "Cuisine", x = "Days from US COVID Lockdown", y = "Polarity") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
