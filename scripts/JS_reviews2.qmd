...
d <- load("../review_data/reviews_1.RData")
# d <- reviews_by_5_no1
# 
# rm(reviews_by_5_no1)
...
# save(d_asian, file = "d_asian_1_5.RData")
# load("../review_data/d_asian_1_5.RData")
...
d_pizza <- inner_join(pizza, reviews, by = "gmap_id") |>
  ...
  filter(year %in% c("2019", "2020", "2021"))
# save(d_pizza, file = "../review_data/d_pizza_1_5.RData")
```
